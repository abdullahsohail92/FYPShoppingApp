...
namespace ShopingApp.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        {
            ViewBag.OrderId = new SelectList(db.Orders, "Id", "UserName");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductId,UnitPrice,Quantity,OrderId")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
